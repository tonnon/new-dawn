const portalVertexShader = document.getElementById("portalVertexShader").textContent;
const portalFragmentShader = document.getElementById("portalFragmentShader").textContent;
...
const debugObject = {
  clearColor: "#00000",
  portalColorStart: "#7A1572",
  portalColorEnd: "#4BC719" };
...
const positionArray = new Float32Array(firefliesCount * 16);
